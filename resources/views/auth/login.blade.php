...
<head>
    ...
    <title>Login - PT Citacontrac</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
    <div class="container">
        ...
        <div class="d-flex">
            <a class="btn btn-outline-primary me-2 {{ request()->routeIs('login') ? 'active fw-bold' : '' }}" href="{{ route('login') }}">Login</a>
            <a class="btn {{ request()->routeIs('register') ? 'btn-primary fw-bold' : (request()->routeIs('login') ? 'btn-outline-primary fw-bold' : 'btn-primary') }}" href="{{ route('register') }}">Register</a>
        </div>
    </div>
</nav>
            ...
            <div class="card bg-white rounded shadow-lg border-0 overflow-hidden wow animate__animated animate__fadeInDown">
                <div class="row g-0">
                    <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center bg-light p-3">
                        <img src="{{ asset('assets/p2.jpg') }}" alt="Login Illustration"
